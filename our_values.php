<?php include 'header.php' ?>
  <div id="maincontent">
    ...
    <h3>Our Values</h3>
    <p>
      Four loko master cleanse squid, neutra deep v hashtag cronut kitsch letterpress fashion axe vice. Pop-up forage kogi taxidermy portland hoodie. 8-bit next level umami offal microdosing four loko. Truffaut kitsch semiotics narwhal heirloom. Art party 3 wolf moon raw denim, food truck hashtag echo park squid. Marfa tofu viral flannel cred irony. Austin kinfolk art party direct trade.</p>
